...
itemOperations:["get", "patch"=>["security"=>"is_granted('ROLE_ADMIN')"]])]
class Professeur
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToMany(targetEntity: Etablissement::class, mappedBy: 'referent')]
    #[Groups(["read"])]
    ...
    public function addEtablissement(Etablissement $etablissement): self
    {
        if (!$this->etablissements->contains($etablissement)) {
            ...
            $etablissement->addReferent($this);
        }
    ...
    public function removeEtablissement(Etablissement $etablissement): self
    {
        if ($this->etablissements->removeElement($etablissement)) {
            $etablissement->removeReferent($this);
        }
